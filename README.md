...
> Professional online AI training for Equinix teams, delivered in association with Centenary Networks,
...
**Audience:** Equinix — a **digital infrastructure business** (data centres, interconnection). Framing is workforce
development for an AI-disrupted sector, aimed at decision-makers and the data centre technicians, field engineers and
operations teams who'll learn.

**The industry line:** *"For a digital infrastructure business, this means data centre technicians, field engineers, and operations and support
teams building real technical and AI capability — practical courses that fit around the working day,
and a credentialed path for the people who want to take it further as infrastructure gets smarter."*
...
- **Subtext:** Professional online AI training for your teams — delivered by Equinix, in association with
