...
(function(){
  ...
  var css=
  ".aiw-btn{position:fixed;right:20px;bottom:20px;z-index:300;display:inline-flex;align-items:center;gap:9px;background:#e91c24;color:#fff;border:0;border-radius:30px;padding:12px 18px;font:600 14px/1 Inter,-apple-system,Segoe UI,sans-serif;cursor:pointer;box-shadow:0 16px 36px -14px rgba(0,161,198,.6)}"+
  ...
  ".aiw-head .av{width:36px;height:36px;border-radius:9px;background:linear-gradient(135deg,#e91c24,#ff4d57);display:grid;place-items:center}.aiw-head .av svg{width:19px;height:19px}"+
  ...
  ".aiw-card{display:block;background:#fff;border:1px solid #dfe7ea;border-left:3px solid #e91c24;border-radius:10px;padding:9px 12px;text-decoration:none}.aiw-card:hover{border-color:#e91c24}"+
  ...
  ".aiw-chip{background:#fff;border:1px solid #dfe7ea;border-radius:30px;padding:7px 11px;font:600 12px Inter,sans-serif;color:#2b2b2b;cursor:pointer}.aiw-chip:hover{border-color:#e91c24;color:#c1141b}"+
  ".aiw-foot{display:flex;gap:8px;padding:10px 12px;border-top:1px solid #dfe7ea;background:#fff;flex:0 0 auto}"+
  ".aiw-foot input{flex:1;border:1px solid #dfe7ea;border-radius:9px;padding:10px 12px;font:14px Inter,sans-serif;color:#2b2b2b}.aiw-foot input:focus{outline:2px solid #e91c24}"+
  ...
  function reply(q){
    ...
    if(has("price","pricing","cost","fee","how much","rate","quote","afford","pay","free")) return [T("Nothing — every course is <b>fully funded by Equinix</b>. You just need to <a href='contact'>register your interest</a> and square the timing with your line manager."),CH(["Register my interest"])];
