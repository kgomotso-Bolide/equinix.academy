/* ===== Equinix Academy — client-side AI assistant (self-contained, no backend) ===== */
(function(){
  if(window.__aiwLoaded)return; window.__aiwLoaded=1;
  var css=
  ".aiw-btn{position:fixed;right:20px;bottom:20px;z-index:300;display:inline-flex;align-items:center;gap:9px;background:#e91c24;color:#fff;border:0;border-radius:30px;padding:12px 18px;font:600 14px/1 Inter,-apple-system,Segoe UI,sans-serif;cursor:pointer;box-shadow:0 16px 36px -14px rgba(233,28,36,.6)}"+
  ".aiw-btn:hover{background:#c1141b}.aiw-btn svg{width:18px;height:18px}.aiw-btn .dot{width:7px;height:7px;border-radius:50%;background:#6c4ba6}"+
  ".aiw-panel{position:fixed;right:20px;bottom:20px;z-index:301;width:min(384px,calc(100vw - 32px));height:min(564px,calc(100vh - 40px));background:#fff;border:1px solid #e4e0ea;border-radius:16px;box-shadow:0 34px 80px -28px rgba(0,0,0,.55);display:none;flex-direction:column;overflow:hidden}"+
  ".aiw-panel.open{display:flex}"+
  ".aiw-head{background:#23182c;color:#fff;padding:14px 15px;display:flex;align-items:center;gap:11px;flex:0 0 auto}"+
  ".aiw-head .av{width:36px;height:36px;border-radius:9px;background:linear-gradient(135deg,#e91c24,#ff6b73);display:grid;place-items:center}.aiw-head .av svg{width:19px;height:19px}"+
  ...
  ".aiw-body{flex:1;overflow-y:auto;padding:15px;background:#f7f5f9;display:flex;flex-direction:column;gap:10px}"+
  ".aiw-msg{max-width:88%;font-size:13.5px;line-height:1.5;padding:10px 13px;border-radius:13px;word-wrap:break-word}"+
  ".aiw-msg.bot{background:#fff;border:1px solid #e4e0ea;align-self:flex-start;color:#2b2b2b;border-bottom-left-radius:4px}"+
  ".aiw-msg.me{background:#e91c24;color:#fff;align-self:flex-end;border-bottom-right-radius:4px}"+
  ".aiw-msg.bot a{color:#c1141b;font-weight:700}.aiw-msg.bot b{color:#1c1c1f}"+
  ".aiw-cards{display:flex;flex-direction:column;gap:7px;align-self:flex-start;max-width:94%}"+
  ".aiw-card{display:block;background:#fff;border:1px solid #e4e0ea;border-left:3px solid #e91c24;border-radius:10px;padding:9px 12px;text-decoration:none}.aiw-card:hover{border-color:#e91c24}"+
  ...
  ".aiw-chip{background:#fff;border:1px solid #e4e0ea;border-radius:30px;padding:7px 11px;font:600 12px Inter,sans-serif;color:#2b2b2b;cursor:pointer}.aiw-chip:hover{border-color:#e91c24;color:#c1141b}"+
  ".aiw-foot{display:flex;gap:8px;padding:10px 12px;border-top:1px solid #e4e0ea;background:#fff;flex:0 0 auto}"+
  ".aiw-foot input{flex:1;border:1px solid #e4e0ea;border-radius:9px;padding:10px 12px;font:14px Inter,sans-serif;color:#2b2b2b}.aiw-foot input:focus{outline:2px solid #e91c24}"+
  ".aiw-foot button{background:#e91c24;border:0;color:#fff;border-radius:9px;padding:0 14px;cursor:pointer;line-height:0}.aiw-foot button:hover{background:#c1141b}.aiw-foot button svg{width:18px;height:18px}"+
